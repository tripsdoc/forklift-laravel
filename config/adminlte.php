...
return [
    ...
    */
    ...
    'logo' => '<b>Hup Soon Cheong</b>',
    'logo_img' => 'vendor/adminlte/dist/img/img_hsc_logo.png',
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/datatables/jquery.dataTables.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '/datatables/dataTables.bootstrap4.css',
                ],
            ],
        ],
        [
